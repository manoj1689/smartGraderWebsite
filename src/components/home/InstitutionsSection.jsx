        ...
        <div className="mt-8 space-y-4">
          <div className="flex items-center gap-2">
            <img
              ...
              alt="Tick Icon"
            />
            <span className="font-medium font-spline text-gray-900 ">Secure Testing Environment</span>
          </div>
          <p className="font-light font-spline text-gray-700">Maintain academic integrity with supervised exams.</p>
          <div className="flex items-center gap-2 mt-4">
            <img
              ...
              alt="Tick Icon"
            />
            <span className="font-medium font-spline text-gray-900 ">Comprehensive Assessments</span>
          </div>
          <p className="font-light font-spline text-gray-700">Test a wide range of subjects with customizable questions.</p>
          <div className="flex items-center gap-2 mt-4">
            <img
              loading="lazy"
              src={buttonRoundedTickImage}
              ...
              alt="Tick Icon"
            />
            <span className="font-medium font-spline text-gray-900 ">Automated Grading</span>
          </div>
          <p className="font-light font-spline text-gray-700">Save time with accurate and fair AI grading.</p>
        </div>
        <motion.div 
