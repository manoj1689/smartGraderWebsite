...
const MobileMenu = ({ scrollToSection }) => {
  ...
  <button
  className="bg-sky-500 hover:bg-sky-700 text-white font-medium py-2 px-4 rounded-[2px] transition duration-300 ease-in-out"
  onClick={() => navigate("signIn")}
>
  Login
</button>
<button
  className="bg-green-500 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-[2px] transition duration-300 ease-in-out ml-4"
