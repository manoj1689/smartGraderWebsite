...
const OrganizationsSection = () => {
  ...
  return (
    <motion.div 
      ...
      className="container mx-auto   flex flex-col  max-w-[1250px] md:flex-row-reverse items-center  rounded-md  px-4"
    ...
    >
      ...
      <div className="flex flex-col justify-center w-full md:w-1/2 text-slate-800">
        <h2 className="text-3xl lg:text-4xl font-bold mb-4 leading-tight text-left ">
        ...
        <motion.div 
          ...
          className="flex items-center cursor-pointer justify-center self-center lg:self-start px-4 py-2 mt-9 text-sm text-white bg-sky-500 rounded-md border border-sky-500 transition-transform duration-300"
